...
<section style="max-width:100px;margin:16px auto;font-family:system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial;">
  <figure style="margin:0 0 24px;">
    <img
      ...
      loading="lazy"
      style="width:20%;height:auto;border:1px solid #e5e7eb;border-radius:10px;"
    />
